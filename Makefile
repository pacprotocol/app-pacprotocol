...
APPNAME ="Dash"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),pacprotocol)
# pacprotocol
DEFINES   += BIP44_COIN_TYPE=8192 BIP44_COIN_TYPE_2=8192 COIN_P2PKH_VERSION=55 COIN_P2SH_VERSION=10 COIN_FAMILY=1 COIN_COINID=\"pacprotocol\" COIN_COINID_HEADER=\"PAC\" COIN_COLOR_HDR=0x0E76AA COIN_COLOR_DB=0x87BBD5 COIN_COINID_NAME=\"pacprotocol\" COIN_COINID_SHORT=\"PAC\" COIN_KIND=COIN_KIND_DASH
APPNAME ="pacprotocol"
APP_LOAD_PARAMS += --path $(APP_PATH)
